...
class B2CPayload(object):
    ...
    def __init__(self, amount=None, command_id=None, initiator_name=None, occasion=None, party_a=None, party_b=None, queue_time_out_url=None, remarks=None, result_url=None, security_credential=None):
        """
        B2CPayload - a model defined in Swagger
        """
    ...
    def amount(self):
        """
        Gets the amount of this B2CPayload.
        The amount been transacted

        :return: The amount of this B2CPayload.
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """
        Sets the amount of this B2CPayload.
        The amount been transacted

        :param amount: The amount of this B2CPayload.
        :type: float
        """
        if amount is None:
    ...
    def command_id(self):
        """
        Gets the command_id of this B2CPayload.
        Unique command for each transaction type

        :return: The command_id of this B2CPayload.
        :rtype: str
        """
    ...
    def command_id(self, command_id):
        """
        Sets the command_id of this B2CPayload.
        Unique command for each transaction type

        :param command_id: The command_id of this B2CPayload.
        :type: str
        """
    ...
    def initiator_name(self):
        """
        Gets the initiator_name of this B2CPayload.
        The name of the initiator initiating the request

        :return: The initiator_name of this B2CPayload.
        :rtype: str
        """
    ...
    def initiator_name(self, initiator_name):
        """
        Sets the initiator_name of this B2CPayload.
        The name of the initiator initiating the request

        :param initiator_name: The initiator_name of this B2CPayload.
        :type: str
        """
    ...
    def occasion(self):
        """
        Gets the occasion of this B2CPayload.
        Optional Parameter

        :return: The occasion of this B2CPayload.
        :rtype: str
        """
    ...
    def occasion(self, occasion):
        """
        Sets the occasion of this B2CPayload.
        Optional Parameter

        :param occasion: The occasion of this B2CPayload.
        :type: str
        """
        if occasion is None:
    ...
    def party_a(self):
        """
        Gets the party_a of this B2CPayload.
        Organization /MSISDN sending the transaction

        :return: The party_a of this B2CPayload.
        :rtype: float
        """
    ...
    def party_a(self, party_a):
        """
        Sets the party_a of this B2CPayload.
        Organization /MSISDN sending the transaction

        :param party_a: The party_a of this B2CPayload.
        :type: float
        """
        if party_a is None:
    ...
    def party_b(self):
        """
        Gets the party_b of this B2CPayload.
        MSISDN sending the transaction

        :return: The party_b of this B2CPayload.
        :rtype: float
        """
    ...
    def party_b(self, party_b):
        """
        Sets the party_b of this B2CPayload.
        MSISDN sending the transaction

        :param party_b: The party_b of this B2CPayload.
        :type: float
        """
        if party_b is None:
    ...
    def queue_time_out_url(self):
        """
        Gets the queue_time_out_url of this B2CPayload.
        The path that stores information of time out transaction

        :return: The queue_time_out_url of this B2CPayload.
        :rtype: str
        """
    ...
    def queue_time_out_url(self, queue_time_out_url):
        """
        Sets the queue_time_out_url of this B2CPayload.
        The path that stores information of time out transaction

        :param queue_time_out_url: The queue_time_out_url of this B2CPayload.
        :type: str
        """
    ...
    def remarks(self):
        """
        Gets the remarks of this B2CPayload.
        Comments that are sent along with the transaction. 

        :return: The remarks of this B2CPayload.
        :rtype: str
        """
    ...
    def remarks(self, remarks):
        """
        Sets the remarks of this B2CPayload.
        Comments that are sent along with the transaction. 

        :param remarks: The remarks of this B2CPayload.
        :type: str
        """
        if remarks is None:
    ...
    def result_url(self):
        """
        Gets the result_url of this B2CPayload.
        The path that stores information of transactions

        :return: The result_url of this B2CPayload.
        :rtype: str
        """
    ...
    def result_url(self, result_url):
        """
        Sets the result_url of this B2CPayload.
        The path that stores information of transactions

        :param result_url: The result_url of this B2CPayload.
        :type: str
        """
    ...
    def security_credential(self):
        """
        Gets the security_credential of this B2CPayload.
        Encrypted Credential of user getting transaction amount

        :return: The security_credential of this B2CPayload.
        :rtype: str
        """
    ...
    def security_credential(self, security_credential):
        """
        Sets the security_credential of this B2CPayload.
        Encrypted Credential of user getting transaction amount

        :param security_credential: The security_credential of this B2CPayload.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, B2CPayload):
            return False
